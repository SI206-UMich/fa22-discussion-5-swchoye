...
class TestAllMethods(unittest.TestCase):
	...
	def test_count_a(self):
		...
		self.assertEqual(count_a("Class"),1)
		pass


	## Check to see whether you can add an item to the warehouse
	def test_add_item(self):
		foodlist=Warehouse(items=[self.item1,self.item2])
		foodlist.add_item(self.item3)	
		self.assertEqual(foodlist.items,[self.item1,self.item2,self.item3])
